        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="register-form">
                    <h2>Registration</h2>
                    <p class=" mb-3">Already Have An Account ? <a href="{{ route('login') }}">Login Here</a></p>
                    <!-- Form -->
                    ...
                    <form method="post" action="{{ route('register.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-sm px-2 py-2" name="name" id="exampleFormControlInput1" placeholder="Name">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control form-control-sm px-2 py-2" name="confirm_password" id="exampleFormControlInput1" placeholder="Confirm Password">
                            <div class="pt-1 text-danger">
