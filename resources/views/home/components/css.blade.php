    ...
    <!-- Title -->
    <title>Job Web Application - A Basic Web</title>

    <!-- Favicon -->
    <link rel="icon" href="{{ asset('home/assets/images/favicon.png') }}">
    ...
    <!-- Datepicker CSS -->
    <link rel="stylesheet" href="{{ asset('home/assets/css/datepicker.css') }}">
    <!-- Animate CSS -->
    ...
    <!-- Color CSS -->
    <link rel="stylesheet" href="{{ asset('home/assets/css/color1.css') }}">
